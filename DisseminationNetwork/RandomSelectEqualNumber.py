...
def dispose_data(seed):
    ...
    return Education_community, Politics_community, Technology_community, Sports_community, Entertainment_community, Business_community
...
def sample_human_data(seed):
    Education_community, Politics_community, Technology_community, Sports_community, Entertainment_community, Business_community = dispose_data(seed)
    CommunityList = [Education_community, Politics_community, Technology_community, Sports_community, Entertainment_community, Business_community]
    filter_data(CommunityList)

if __name__ == '__main__':
    sample_human_data(seed = 42)